...
public class Compiler {
     ...
     *				object program.
     * @param	showingAST	true if the AST is to be displayed after
     *				contextual analysis (not currently implemented).
     * @param	showingTable	true if the object description details are to
     *				be displayed during code generation (not
     *				currently implemented).
     * @return	true if the source program is free of compile-time errors,
     *          otherwise false.
     */
